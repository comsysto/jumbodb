...
public class JsonLz4DataRecordReader extends RecordReader<LongWritable, Text> {
    private static final Log LOG = LogFactory.getLog(JsonLz4DataRecordReader.class);
    ...
    public JsonLz4DataRecordReader() {
    }
