 ...
 * @author Carsten Hufe
 */
public class LongEqOperationSearch extends NumberEqOperationSearch<Long, NumberSnappyIndexFile<Long>> {


    public LongEqOperationSearch(NumberSnappyIndexStrategy<Long, NumberSnappyIndexFile<Long>> strategy) {
        super(strategy);
    }
