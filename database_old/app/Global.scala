...
import core.management.StorageManagement
import play.api._
import java.io.File
import core._
...
object Global extends GlobalSettings {
  ...
  var storageManagement: StorageManagement = null
  ...
  override def onStart(app: Application) {
    ...
    storageManagement = new StorageManagement(dataPath, indexPath, queryServer)
