 ...
 * @author Carsten Hufe
 */
class DateTimeGtOperationSearchSpec extends spock.lang.Specification {
    ...
    def "greater match #value < #testValue == #isGreater"() {
        ...
        operation.matching(sdf.parse(testValue).getTime(), operation.getQueryValueRetriever(queryClause)) == isGreater
        where:
    ...
    def "acceptIndexFile value=#queryValue indexFileFrom=#indexFileFrom indexFileTo=#indexFileTo"() {
        ...
        "2013-10-01 12:00:00" | "2012-10-01 12:00:00" | "2013-10-01 12:00:00" | false
    }

    def "getQueryValueRetriever"() {
        when:
        def valueRetriever = operation.getQueryValueRetriever(new QueryClause(QueryOperation.GT, "2013-10-01 11:59:59"))
        then:
