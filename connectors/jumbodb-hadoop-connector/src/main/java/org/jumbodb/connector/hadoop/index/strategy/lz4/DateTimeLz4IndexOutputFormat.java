...
public class DateTimeLz4IndexOutputFormat extends AbstractLz4IndexOutputFormat<LongWritable, FileOffsetWritable> {
    public static final String DATETIME_LZ4 = "DATETIME_LZ4";
