 ...
 * @author Carsten Hufe
 */
public class FloatLz4IndexStrategy extends NumberLz4IndexStrategy<Float, Float, NumberIndexFile<Float>> {

    public static final int LZ4_INDEX_BLOCK_SIZE = 32 * 1024; // must be a multiple of 16! (4 byte float data, 4 byte file name hash, 8 byte offset)

    private Logger log = LoggerFactory.getLogger(FloatLz4IndexStrategy.class);
