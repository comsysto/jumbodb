 ...
 * @author Carsten Hufe
 */
public class DoubleLz4IndexStrategy extends NumberLz4IndexStrategy<Double, Double, NumberIndexFile<Double>> {

    public static final int LZ4_INDEX_BLOCK_SIZE = 32 * 1020; // must be a multiple of 20! (8 byte double data, 4 byte file name hash, 8 byte offset)

    private Logger log = LoggerFactory.getLogger(DoubleLz4IndexStrategy.class);
