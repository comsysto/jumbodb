 ...
 * @author Carsten Hufe
 */
public abstract class AbstractJumboDataInputFormat extends FileInputFormat<LongWritable, Text> {
    @Override
    ...
    protected abstract RecordReader<LongWritable,Text> getRecordReader(byte[] recordDelimiterBytes);
}
