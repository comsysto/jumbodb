...
public class HashCode32Lz4IndexOutputFormat extends AbstractLz4IndexOutputFormat<IntWritable, FileOffsetWritable> {
    public static final String HASHCODE32_LZ4 = "HASHCODE32_LZ4";
