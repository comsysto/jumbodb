...
public class GeohashQueryValueRetriever implements QueryValueRetriever {
    ...
    public GeohashQueryValueRetriever(QueryClause queryClause) {
        ...
        double latitude1 = coords.get(0).get(0).floatValue();
        double longitude1 = coords.get(0).get(1).floatValue();
        double latitude2 = coords.get(1).get(0).floatValue();
        double longitude2 = coords.get(1).get(1).floatValue();
