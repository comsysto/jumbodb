...
public class MsgPackSnappyDataOutputFormat<K, V> extends TextOutputFormat<K, V> {
    public static final String STRATEGY_KEY = "MSGPACK_SNAPPY";
    ...
    private class SnappyDataWriter extends RecordWriter<K, V> {
        ...
        public synchronized void write(K key, V value)
            ...
            byte[] bytes = messagePack.write(map);
