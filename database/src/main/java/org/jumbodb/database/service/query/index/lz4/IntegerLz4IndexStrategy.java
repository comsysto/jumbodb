 ...
 * @author Carsten Hufe
 */
public class IntegerLz4IndexStrategy extends NumberLz4IndexStrategy<Integer, Integer, NumberIndexFile<Integer>> {

    public static final int LZ4_INDEX_BLOCK_SIZE = 32 * 1024; // must be a multiple of 16! (4 byte integer data, 4 byte file name hash, 8 byte offset)

    private Logger log = LoggerFactory.getLogger(IntegerLz4IndexStrategy.class);
