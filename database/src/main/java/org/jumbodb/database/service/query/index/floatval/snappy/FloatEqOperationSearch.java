 ...
 * @author Carsten Hufe
 */
public class FloatEqOperationSearch extends NumberEqOperationSearch<Float, NumberSnappyIndexFile<Float>> {


    public FloatEqOperationSearch(NumberSnappyIndexStrategy<Float, NumberSnappyIndexFile<Float>> strategy) {
        super(strategy);
    }
