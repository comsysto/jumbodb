 ...
 * @author Carsten Hufe
 */
public class LongSnappyIndexStrategy extends NumberSnappyIndexStrategy<Long, NumberSnappyIndexFile<Long>> {
    ...
    @Override
    public Map<QueryOperation, OperationSearch<Long, NumberSnappyIndexFile<Long>>> getQueryOperationsStrategies() {
        Map<QueryOperation, OperationSearch<Long, NumberSnappyIndexFile<Long>>> operations = new HashMap<QueryOperation, OperationSearch<Long, NumberSnappyIndexFile<Long>>>();
