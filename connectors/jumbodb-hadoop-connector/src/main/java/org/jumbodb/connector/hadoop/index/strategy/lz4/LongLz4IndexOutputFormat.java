...
public class LongLz4IndexOutputFormat extends AbstractLz4IndexOutputFormat<LongWritable, FileOffsetWritable> {
    public static final String LONG_LZ4 = "LONG_LZ4";
