...
public class MsgPackSnappyDataRecordReader extends RecordReader<LongWritable, Text> {
    private static final Log LOG = LogFactory.getLog(MsgPackSnappyDataRecordReader.class);
    ...
    public MsgPackSnappyDataRecordReader() {
    }
