 ...
 * @author Carsten Hufe
 */
class LongLtEqOperationSearchSpec extends Specification {
    def operation = new LongLtEqOperationSearch()
    ...
    def "getQueryValueRetriever"() {
        when:
        def valueRetriever = operation.getQueryValueRetriever(new IndexQuery("testIndex", QueryOperation.LT_EQ, 5l))
        then:
