 ...
 * @author Carsten Hufe
 */
class LongGtEqOperationSearchSpec extends Specification {
    def operation = new LongGtEqOperationSearch()
    ...
    def "getQueryValueRetriever"() {
        when:
        def valueRetriever = operation.getQueryValueRetriever(new IndexQuery("testIndex", QueryOperation.GT_EQ, 5l))
        then:
